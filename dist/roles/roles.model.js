...
__decorate([
    swagger_1.ApiProperty({ example: 'ADMIN', description: 'Роль пользователя', nullable: false }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'Может удалять и добавлять посты', description: 'Описание роли пользователя', nullable: false }),
...
Role = __decorate([
    sequelize_typescript_1.Table({ tableName: 'role' })
], Role);
exports.Role = Role;
